...
main (int argc, char *argv[]) {
	...
	double box_x, box_y, box_z, dist_x, dist_y, dist_z, *r, distance, const_fact, rlower, rupper, nideal, ***grdf, rho, *average_val, phi, *dz, delta_z, *integration;
	...
	integration = (double *) malloc(n_of_param*(sizeof(double)));
